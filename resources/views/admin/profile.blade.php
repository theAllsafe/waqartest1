				  ...
				  <ul class="todo-list ui-sortable">
					<li class="p-15">
					  <div class="box p-15 mb-0 d-block bb-2 border-secondary">
						 <!-- drag handle -->
						  <form novalidate action="{{ url('admin/updateprofile') }}" method="POST" enctype="multipart/form-data">
        				        @csrf
        					<div class="form-group row">
        						<label class="col-form-label col-md-2">Name</label>
        						<div class="col-md-10">
        						    <div class="controls">
        							<input value="{{$data->name}}" class="form-control" type="text" name="name" required data-validation-required-message="This field is required">
        						    </div>
        						</div>
        					</div>
        					...
        					<div class="form-group row">
        						...
        						<div class="col-md-10">
        							<div class="controls">
        								<input  value="{{$data->email}}" type="email" name="email" class="form-control" required data-validation-required-message="This field is required"> 
        							</div>
        						</div>
        					</div>	
        					<div class="form-group row">
				  ...
				  <ul class="todo-list ui-sortable">
					<li class="p-15">
					  <div class="box p-15 mb-0 d-block bb-2 border-danger">
						 <form novalidate action="{{ url('admin/changepassword') }}" method="POST">
        				        @csrf
        					<div class="form-group row">

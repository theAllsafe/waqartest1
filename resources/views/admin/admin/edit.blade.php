			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-header">
					<h4 class="box-title">Edit Partner</h4>  
				</div>
        		...
        		@endif
				<div class="box-body">
				    <form novalidate action="{{ url('admin/admin/update/') }}/{{$admin['id']}}" method="POST">
				        {{csrf_field()}}
                        {{method_field('PUT')}}
					<div class="form-group row">
						...
						<div class="col-md-10">
						    <div class="controls">
							<input class="form-control" type="text" name="name" value="{{$admin['name']}}" placeholder="Institue Name" required data-validation-required-message="This field is required">
						    </div>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-md-10">
							<div class="controls">
								<input type="email" name="email" class="form-control" value="{{$admin['email']}}" required data-validation-required-message="This field is required"> 
							</div>
						</div>
					</div>	

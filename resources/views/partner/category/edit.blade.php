		  ...
		  <div class="row">
			...
			<div class="col-12">
			  <div class="box">
        		...
        		@endif
				<div class="box-body">
				    <form novalidate action="{{ url('admin/category/update/') }}/{{$class['id']}}" method="POST">
				        {{csrf_field()}}
                        {{method_field('PUT')}}
					@csrf
    				<div class="form-group row">
    					...
    					<div class="col-md-10">
    					    <div class="controls">
    						<input class="form-control" type="text" value="{{$class['category_name']}}" name="category_name" required data-validation-required-message="This field is required">
    					    </div>
    					</div>
    				</div>

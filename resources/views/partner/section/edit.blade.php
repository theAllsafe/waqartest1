			...
			<div class="col-12">
			  <div class="box">
				...
				<div class="box-header">
					<h4 class="box-title">Edit Section </h4>  
				</div>
        		...
        		@endif
				<div class="box-body">
				    <form novalidate action="{{ url('partner/section/update/') }}/{{$section['id']}}" method="POST">
				        {{csrf_field()}}
                        {{method_field('PUT')}}
					@csrf
    				<div class="form-group row">
    					...
    					<div class="col-md-10">
    					    <div class="controls">
    						<input class="form-control" value="{{$section['section_name']}}" type="text" name="section" required>
    					    </div>
    					</div>
    				</div>

		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				...
				<div class="right-title">
				    <button data-toggle="modal" data-target="#modal-center" class="btn btn-outline btn-success mb-5">Add Class</button>
				</div>
			</div>
		</div>
							...
							<table id="example1" class="table table-striped table-bordered display" style="width:100%">
								...
								<tbody>@foreach($users as $key => $value)
									<tr>
										...
										<td>{{$value->class}}</td>
										<td><a class="btn btn-outline btn-success mb-5" href="{{ url('partner/class/edit') }}/{{$value->id}}"><i class="fa fa-edit"></i></a>
                    						<a class="btn btn-outline btn-success mb-5" href="{{ url('partner/class/destroy') }}/{{$value->id}}" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                    					</td>
									</tr>@endforeach
								</tbody>
					</table>
  ...
  <div class="modal center-modal fade" id="modal-center" tabindex="-1">
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <form novalidate action="{{ url('partner/class/store') }}" method="POST">
		  <div class="modal-body">
			<div class="box-body">
			    ...
			    <div class="form-group row">
					...
					<div class="col-md-10">
					    <div class="controls">
					        <select class="form-control" name="category" required data-validation-required-message="This field is required">
				...
				<div class="form-group row">
					...
					<div class="col-md-8">
					    <div class="controls">
						<input class="form-control" type="text" name="class[]" required data-validation-required-message="This field is required">
					    </div>
					</div>
					<div class="col-md-1">
    				    <div class="controls">
